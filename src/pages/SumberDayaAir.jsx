...
const SumberDayaAir = () => {
  return (
    <>
      <Helmet>
        <title>Sektor Sumber Daya Air | PT Citra Diecona</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="citra diecona, PT Citra Diecona,sektor sumber daya air, sumber daya air, perusahaan yang bergerak di bidang konstruksi, pembangunan, dan manufaktur, konsultan proyek, consulting engineers"
        />
      </Helmet>
      ...
      >
        <div className="h-[245px] w-full bg-black/50">
          <div className="container py-20 md:py-20">
      ...
      <div className="pt-5 lg:pt-14 pb-14">
        <div className="container">
          <h1 className="text-base md:text-lg">
            Selain bergerak dibidang Konstruksi Infrastruktur,
            <span className="font-semibold"> PT. CITRA DIECONA</span> sangat
            signifikan dalam menjalankan peran penting untuk memastikan
            kesuksesan proyek-proyek Konstruksi di sektor sumber daya air.
            Dengan Pengalaman yang sudah lebih dari 10 tahun, Kami menyediakan
            panduan, pengetahuan, dan pengalaman teknis yang mendalam untuk
            membimbing proyek-proyek ini menuju pencapaian tujuan mereka. Dengan
            berbagai layanan yang kami tawarkan, kami tidak hanya menjadi mitra
            yang andal, tetapi juga berfungsi sebagai pendorong utama di balik
          ...
          <div className="pt-5">
            ...
            <ul className="list-disc list-outside ml-5 mt-3">
              <li className="text-base md:text-lg">
                Proyek Konstruksi dan Pemeliharaan
              </li>
              <p className="text-base md:text-lg pt-1">
                Ini mencakup Study, Perencanaan, Desain, dan Supervisi
                proyek-proyek yang mendukung kegiatan konstruksi, seperti
                Bangunan Air, Dermaga, Pelabuhan, Pengendalian Banjir,
                Pembangunan wilayah seperti daerah pantai, rawa, sungai, dan
                danau. Kami juga melakukan penelitian tentang geologi, jenis
                tanah, batuan, dan hidrologi (siklus air) di suatu wilayah. Hal
                ini penting untuk memahami sumber daya air, seperti sungai dan
                danau, serta dampaknya pada lingkungan dan keberlanjutan air.
              </p>
